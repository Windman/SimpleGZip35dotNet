...
Оценивается использование ООП, паттернов, обработка исключений, 
 * синхронизация потоков, умение работать с ресурсами (Dispose, using), 
 * использование примитивов синхронизации, читаемость кода итп.
